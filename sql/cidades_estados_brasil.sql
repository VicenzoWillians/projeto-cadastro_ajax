Create database if not exists projeto_terceiroB;

use projeto_terceiroB;
...
(
    ...
    endereco_pessoa varchar(60),
    telefone_pessoa varchar(50),
...
-- show tables;
-- drop database projeto_terceiroB;